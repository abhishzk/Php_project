...
if(isset($_COOKIE["rememberCookieUname"]))
{
	...
	{
		$query = "SELECT * FROM login_tbl where u_id='$rememberCookieUname' and stat='1'";
...
if(isset($_SESSION["id"]))
{
	...
	$get_ck = mysqli_query($conn,"SELECT * FROM login_tbl where u_id='$id1' and pass='$pass1' and stat='1'");
