...
<html lang="en">
  ...
  <script type="text/javascript">
      ...
      function funCourse(id)
      {
        setTimeout(function(){
          $('#light_box').load('modal/assign-modal.php?uid='+id); /*Modal Content Load from page location*/
  ...
  <body class="nav-md">
          ...
          <div class="" style="margin-top:50px;">
            <div class="page-title">
              <div class="title_left">
                <h3><i class="fa fa-cog"></i>&nbsp;Assign Subjects</h3>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="x_panel">
                <div class="x_title">
                  <h2>Assign Subjects to Teacher<small>Fill the form to assign subjects.</small></h2>
                ...
                <input type="hidden" name="blank" id="blank" value="">
                  ...
                  <form class="form-horizontal form-label-left" name="manage_subjects" id="manage_subjects" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                      ...
                      <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
                        <div class="input-group">
                          ...
                          <span class="input-group-btn">
                            <button type="button" class="btn btn-primary" onclick="funCourse('<?php echo $row['course_id'];?>')"><i class="fa fa-plus"></i></button>
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
                        <select class="form-control col-md-7 col-xs-12" id="subject" name="subject" required="required">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
                        <input class="form-control col-md-7 col-xs-12" placeholder="e.g. Teacher Mobile Number" name="mobile" id="mobile" onkeypress='return event.charCode >= 48 && event.charCode <= 57; validate(event)' maxlength="10" type="text" value="">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12" id="teacher_div">
                ...
                <div class="x_content">
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      ...
                      $get_user = mysqli_query($conn,"SELECT * FROM assign_subject");
                      while($row_user = mysqli_fetch_array($get_user))
                      {
                        ...
                        $get_subject = mysqli_query($conn,"SELECT * FROM subject_dtls where subject_id = '$subject_id'");
                        while($row_subject = mysqli_fetch_array($get_subject))
                        {
                          $snm = $row_subject['subject_nm'];
                        }

                        $get_usernm = mysqli_query($conn,"SELECT * FROM user_dtls where user_id = '$teacher_id'");
                        while($row_usernm = mysqli_fetch_array($get_usernm))
                        {
                          $tnm = $row_usernm['user_nm'];
                        }
                      ?>
                      <tr>
                        <td><?php echo $s_i;?></td>
    ...
    <!-- script for ajax -->
  <script type="text/javascript" src="js/assign-subject.js"></script>
